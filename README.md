...
Trae Solo 一个 zip 装一个 skill。从 [GitHub Releases](https://github.com/YYYYYZhao/Lytskill/releases) 下载最新的 `lytskill-版本号.zip`，解压后里面是 3 个独立的 skill zip（每个 zip 解压后根级是 `SKILL.md`），逐个拖进 Trae Solo 的「上传技能」窗口即可。
